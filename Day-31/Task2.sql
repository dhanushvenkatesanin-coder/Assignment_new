...
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(101,"rajesh","Maths",20);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(102,"rakesh","Maths",20);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(103,"reshma","Maths",18);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(104,"rahul","Maths",17);
insert into assignments(student_id,student_name,subject_name,assignment_mark)values(105,"akash","Maths",16);
