...
student_age int);
select * from user;
insert into user(student_name,student_age) values ("rahul",20)
insert into user(student_name,student_age) values ("rakesh",21)
insert into user(student_name,student_age) values ("reshma",22)
insert into user(student_name,student_age) values ("rajesh",21)
