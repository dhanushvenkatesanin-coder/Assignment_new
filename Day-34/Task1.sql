create database nf;
use nf;
-- Run in a sandbox DB. Drop tables if they exist.
-- ============================================



-- =================================================
-- 0) Denormalized example (violates 1NF / repeating groups)
-- =================================================
...
-- CourseOfferings: a course can be offered multiple times (term, instructor)
-- This separates offerings from static course attributes (eliminates partial deps -> 2NF)
